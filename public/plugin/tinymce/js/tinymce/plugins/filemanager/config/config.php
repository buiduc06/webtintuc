...
| <input type="button" href="../filemanager/dialog.php?field_id=imgField&lang=en_EN&akey=somethingkey" value="Files">
| in tinymce a new parameter added: filemanager_access_key:"somethingkey"
| example tinymce config:
|
| tiny init ...
| external_filemanager_path:"../filemanager/",
| filemanager_title:"Filemanager" ,
| filemanager_access_key:"somethingkey" ,
| ...
|
*/
